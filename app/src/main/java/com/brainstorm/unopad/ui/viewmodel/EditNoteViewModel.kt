package com.brainstorm.unopad.ui.viewmodel
...
import com.brainstorm.unopad.ui.NoteItem
import com.brainstorm.unopad.ui.toReadableTime
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (note != null) {
                val noteItem = NoteItem(
                    ...
                    lastModified = note.lastModified.toReadableTime()
                )
    ...
    companion object {
        ...
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
                val application =
                    checkNotNull(extras[ViewModelProvider.AndroidViewModelFactory.Companion.APPLICATION_KEY]) as UnoPadApp
